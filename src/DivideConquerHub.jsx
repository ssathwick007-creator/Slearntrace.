    ...
    return (
        <div style={styles.shell}>
            ...
            <div style={styles.header}>
                <h2 style={styles.title}>Divide and Conquer — Splitting Problems into Smaller Parts</h2>
                <p style={styles.subtitle}>
                    ...
                    This technique is widely used in efficient algorithms like Merge Sort, Quick Sort, and computational geometry problems.
                </p>
            </div>
