...
import MazePathFinder from './MazePathFinder.jsx';
import BacktrackingPracticeProblems from './BacktrackingPracticeProblems.jsx';

const btTabs = [
    { id: 'nqueens', label: 'N-Queens' },
    { id: 'sudoku', label: 'Sudoku Solver' },
    { id: 'maze', label: 'Maze Path Finder' },
...
const BacktrackingHub = () => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'sudoku': return <SudokuSolver />;
            case 'maze': return <MazePathFinder />;
            case 'practice': return <BacktrackingPracticeProblems />;
            default: return <ComingSoon name={btTabs.find(t => t.id === activeTab)?.label} />;
        }
    };
    ...
    return (
        <div style={styles.shell}>
            ...
            <div style={styles.header}>
                <h2 style={styles.title}>Backtracking Algorithms — Exploring All Possibilities</h2>
                <p style={styles.subtitle}>Backtracking algorithms explore all possible solutions to a problem by trying different choices and undoing them if they lead to a dead end. They are commonly used in puzzles, pathfinding, and combinatorial problems.</p>
            </div>
...
export default BacktrackingHub;
